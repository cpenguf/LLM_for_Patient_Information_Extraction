...
# GatorTron MRC-style NER inference using ClinicalTransformerMRC
...
OUTPUT_FN=${OUTPUT_FN:-outputs/gatortron_mrc_ner/predictions.json}
DATA_SIGN=${DATA_SIGN:-./label2idx.json}
