...
# Example launcher for Llama 3.1 inference (LoRA/PEFT or base).
# Override the env vars to point at your resources; no local defaults are baked in.

BASE_MODEL=${BASE_MODEL:?set to your llama3.1 .nemo path}
OUTPUT_FILE=${OUTPUT_FILE:-outputs/inference/llama31_predictions.jsonl}
